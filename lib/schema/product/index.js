...
const Product = new Schema({
  ...
  compare_at_price_max:{type: String}, // Returns the highest compare at price
  compare_at_price_min:{type: String}, // Returns the lowest compare at price
  // price_max:{}, //
  // price_min:{}, //
  ...
  price: {type: String, required: true}, // Static method
